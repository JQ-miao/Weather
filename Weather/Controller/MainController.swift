...
class MainController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        WeatherNetwork.GET(url:w_server + w_daily  , parsDic: ["key":w_api_key,"location":"dalian"])
        Utils.observer(name: W_CITY, observer: self, selector: #selector(aaa))
    }
    
    func aaa(notifaction: NSNotification) {
        print("xxx");
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "w_cell", for: indexPath)
